import type { TelemetryContext } from "@liyuan/telemetry";
...
export interface Model<TApi extends Api> {
    ...
    compat?: TApi extends "openai-completions" ? OpenAICompletionsCompat : TApi extends "openai-responses" | "azure-openai-responses" | "openai-codex-responses" ? OpenAIResponsesCompat : TApi extends "anthropic-messages" ? AnthropicMessagesCompat : TApi extends "google-generative-ai" | "google-vertex" ? GoogleCompat : TApi extends "bedrock-converse-stream" ? BedrockCompat : never;
}
