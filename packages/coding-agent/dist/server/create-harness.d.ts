import { AgentHarness, type AgentHarnessOptions, type ExecutionEnv, type HarnessTool } from "@liyuan/agent-core";
...
export declare function createCodingAgentHarness(options: CreateCodingAgentHarnessOptions): Promise<{
    ...
    suspended: import("@liyuan/agent-core").SuspendedOperation[];
}>;
