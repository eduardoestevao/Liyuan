...
export default defineConfig({
	resolve: {
		alias: [
			{ find: /^@liyuan\/telemetry$/, replacement: workspaceSourcePaths.telemetryIndex },
			{ find: /^@liyuan\/telemetry\/testing$/, replacement: workspaceSourcePaths.telemetryTesting },
			{ find: /^@liyuan\/ai$/, replacement: workspaceSourcePaths.aiIndex },
			{ find: /^@liyuan\/ai\/compat$/, replacement: workspaceSourcePaths.aiCompat },
			{ find: /^@liyuan\/ai\/oauth$/, replacement: workspaceSourcePaths.aiOAuth },
			{
				find: /^@liyuan\/ai\/providers\/(.+)$/,
				replacement: `${workspaceSourcePaths.aiProviders}/$1.ts`,
			},
			{ find: /^@liyuan\/agent-core$/, replacement: workspaceSourcePaths.agentIndex },
			{ find: /^@liyuan\/tui$/, replacement: workspaceSourcePaths.tuiIndex },
		],
	},
});
