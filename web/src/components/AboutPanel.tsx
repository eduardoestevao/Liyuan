		...
		<div className="panel-body about-panel-body">
			...
			<div className="about-hero">
				...
				<div className="about-hero-text">
					<h3 className="about-hero-title">梨园 Liyuan</h3>
					<div className="about-hero-tagline">
						基于 pi 构建的 RP Agent · 将 Coding Agent 能力全面 RP 化
					</div>
				</div>
			</div>
			...
			<section className="sp-section">
				...
				<div className="about-status-grid">
					...
					<div className="about-status-row">
						<span className="about-label">运行环境</span>
					...
					{hasNewVersion ? (
						<div className="about-update-alert">
							<span className="about-update-msg">
								发现新版本 <b>v{update.latestVersion}</b>
			...
			<section className="sp-section">
				...
				<div className="about-license-block">
					<div className="about-license-item">
						<strong>主项目许可</strong>：
						<span>PolyForm Noncommercial 1.0.0（个人与非商业用途自由使用、修改与分发）</span>
					</div>
					<div className="about-license-item" style={{ marginTop: 6 }}>
						<strong>内核架构</strong>：
						<span>基于 <a href="https://github.com/earendil-works/pi" target="_blank" rel="noreferrer">pi</a>（MIT 许可）二次开发，保留原版权声明</span>
					</div>
				</div>
			</section>
